...
function AgreementOverlay({ onAgree, onDisagree }: AgreementOverlayProps) {
  return (
        ...
        <div className="agreement-window">
          ...
          <div className="agreement-window-footer">
            ...
            <div className="agreement-actions">
              <button className="btn btn-secondary" onClick={onDisagree}>不同意并退出</button>
              <button className="btn btn-primary" onClick={onAgree}>同意并继续</button>
            </div>
          </div>
        </div>
      </div>
